...
// NOTE: client-side helpers (serializeSubtree, mergeTransformedSubtreeIntoOutline)
// live at src/lib/transform-outline-helpers.ts. Next.js's `'use server'`
// directive requires every export from this file to be an async function;
// pure helpers belong in a separate module.
