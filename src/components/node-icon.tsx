...
const typeColorMap: Partial<Record<NodeType, string>> = {
  ...
  task: 'text-emerald-600 dark:text-emerald-400',
  link: 'text-blue-600 dark:text-blue-400',
  'outline-link': 'text-blue-600 dark:text-blue-400',
  ...
  canvas: 'text-emerald-500 dark:text-emerald-400',
};
