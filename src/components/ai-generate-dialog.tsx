  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[480px]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2"><Bot /> Generate Suboutline from Topic</DialogTitle>
          <DialogDescription>
            Enter a topic and AI will generate a structured suboutline under the selected node. Edit the topic if you want to refine it.
          </DialogDescription>
        </DialogHeader>
