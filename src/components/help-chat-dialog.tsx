...
- Outline management: The sidebar (panel-toggle button at top-left of toolbar) is the sole path for switching, creating, renaming, deleting, and searching outlines. The toolbar shows the current outline name as a read-only title plus two small icon buttons: Import (down-arrow) and Export (up-arrow). Import menu contains: Research & Import, Import Outline, Restore All Outlines (plus "Import Email" when inbound email import is enabled in Settings > Professional Customization). Export menu contains: Share Suboutline as…, Export Current Outline, Backup All Outlines. (The previous Wrench / Refresh User Guide menu was retired 2026-06-07 — the User Guide is now read-only and reloads from the bundled app version on every launch, so a manual refresh is no longer needed.)
