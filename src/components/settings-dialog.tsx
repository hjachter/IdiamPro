        ...
        <div className="flex flex-col sm:flex-row gap-4 py-4">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1.5 text-xs text-muted-foreground">
              ...
              <li>
                <strong className="text-foreground">Your own key (BYOK):</strong> your content goes to your chosen provider under your own account. IdeaM never sees it.
              </li>
              <li>
          ...
          <div className="space-y-3 pt-2 border-t border-border/40">
            ...
            <p className="text-xs text-muted-foreground">
              IdeaM stores all your data locally on this device. Use these
            ...
            <div className="flex items-center justify-between gap-4 rounded-md border border-amber-500/40 bg-background/60 p-3">
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  ...
                  the &ldquo;Made with IdeaM&rdquo; watermark, and Pro upgrade prompts.
                </p>
              </div>
              <Switch
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              <h3 className="text-base font-semibold">IdeaM</h3>
          ...
          <div id="ai-service-keys-section" className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              provider directly, IdeaM takes nothing.
            </p>
            ...
            {!apiKeys['gemini'] && (
              <div className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
                ...
                <p className="text-xs text-muted-foreground mb-2">
                  Google Gemini is free and powers most IdeaM AI features. No credit card required.
                </p>
                <Button
                  variant="outline"
                  size="sm"
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2">
              ...
              Delete all your IdeaM data?
            </AlertDialogTitle>
            <AlertDialogDescription asChild>
              <div className="space-y-2 text-sm">
                <p>
                  This will permanently remove everything IdeaM stores on
                  this device:
                </p>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription asChild>
              <div className="space-y-3 text-sm">
                <p>
                  This will permanently erase all your IdeaM data on this
