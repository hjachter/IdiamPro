...
- Responsive toolbar (2026-06-06): The toolbar adapts to screen width via three tiers. Anchors (sidebar toggle on the left, account avatar on the right) are always visible. PHONE [< 640px]: only Ask AI, Plus, Delete, and Search show inline; everything else collapses into a "More tools" overflow menu (three-dot icon to the left of the avatar) — Import, Export, Focus Mode, Show or hide all, Share subtree, Command palette, Second Brain, Smart Tools, Settings, Help, Refresh User Guide. TABLET [640-1023px]: adds Import, Export, Focus Mode, Show or hide all, Share subtree, Command palette, Second Brain, Smart Tools inline; the overflow keeps Settings, Help, Refresh User Guide. DESKTOP [>= 1024px]: every button is inline and the overflow icon disappears. All keyboard shortcuts (Cmd+K, Cmd+F, Cmd+E, Cmd+Shift+E, Cmd+Shift+F, Cmd+Shift+I, etc.) work at every width regardless of whether the matching button is inline or in the overflow. The previous "Import as Chapter" toolbar action was retired the same day — copy/paste already covers the same intent more intuitively.
