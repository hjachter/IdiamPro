...
export default function BetaSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const subject = encodeURIComponent('Beta Tester Application - IdeaM');
...
I would like to join the IdeaM beta program.
    `);

    window.location.href = `mailto:support@2ndbrainware.com?subject=${subject}&body=${body}`;
      ...
      <header className="relative z-10 px-6 py-6 lg:px-12">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">IdeaM</span>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/60 max-w-2xl mx-auto mb-8">
              Be among the first to experience IdeaM&apos;s intelligence amplification platform.
              ...
              {isSubmitted ? (
                <div className="p-8 rounded-3xl bg-gradient-to-br from-blue-500/20 to-blue-500/10 border border-blue-500/30 text-center">
                  ...
                  <p className="text-white/60 mb-6">
                    Thank you for your interest in IdeaM. We&apos;ll review your application and
                ...
                <form onSubmit={handleSubmit} className="p-8 rounded-3xl bg-white/5 border border-white/10">
                  ...
                  <div className="space-y-5">
                    ...
                    <p className="text-center text-white/30 text-xs">
                      By applying, you agree to provide feedback and help us improve IdeaM.
                    </p>
                  </div>
                </form>
              )}
      ...
      <footer className="relative z-10 px-6 py-8 border-t border-white/10 mt-16">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/30 text-sm">
            © 2026 IdeaM. Your Intelligence Amplifier.
          </p>
          <div className="flex items-center gap-6">
            ...
            <a href="mailto:support@2ndbrainware.com" className="text-white/30 hover:text-white text-sm transition-colors">Contact</a>
          </div>
        </div>
      </footer>
    </div>
