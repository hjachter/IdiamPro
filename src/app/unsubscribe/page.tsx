...
export default async function UnsubscribePage({ searchParams }: PageProps) {
  ...
  return (
    ...
    >
      ...
      >
        <a href="/" aria-label="IdeaM home" style={{ display: 'inline-block', color: '#007AFF', fontWeight: 700, fontSize: '20px', marginBottom: '16px', textDecoration: 'none', cursor: 'pointer' }}>
          IdeaM
        </a>
        ...
        {result.kind === 'success' && !result.alreadyUnsubbed && (
          <>
            ...
            <p style={{ margin: 0, color: '#374151', lineHeight: 1.6 }}>
              We won&rsquo;t send you any more onboarding emails. You can keep using IdeaM the same as
        ...
        {result.kind === 'invalid' && (
          <>
            ...
            <p style={{ margin: 0, color: '#374151', lineHeight: 1.6 }}>
              ...
              IdeaM email and we&rsquo;ll take you off the list by hand.
            </p>
          </>
        )}
