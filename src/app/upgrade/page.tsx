...
const PLANS: PlanCard[] = [
  {
    ...
    features: [
      ...
      'Bring your own AI key — Google Gemini for text by default, or plug in your own key for Anthropic Claude, OpenAI GPT, Groq, or Mistral (pay your provider directly). OpenAI powers premium voices',
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:py-16">
        ...
        <div className="mt-12 grid gap-4 text-center text-sm text-muted-foreground sm:grid-cols-3">
          ...
          <div className="flex flex-col items-center gap-2 rounded-xl border bg-card p-4">
            ...
            <span>
              One subscription unlocks IdeaM everywhere you use it.
            </span>
          </div>
        </div>
