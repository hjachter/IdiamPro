...
function createWelcomeNodes(): { rootNodeId: string, nodes: NodeMap } {
  ...
  createNode(nodes, rootId, null, "Welcome to IdeaM!", `<p><strong>Congratulations!</strong> You've just unlocked a powerful tool for organizing your thoughts, research, and knowledge.</p>

<p>IdeaM is your <strong>Second Brain</strong> — an intelligence amplifier that helps you capture, connect, and recall everything you learn.</p>
...
<p>Your outline can be as deep or as flat as you need. IdeaM handles <strong>over 1 million nodes</strong> with ease!</p>`);
...
<p>Click <strong>Import</strong> in the toolbar to get started.</p>`);
  ...
  createNode(nodes, step5Id, rootId, "Step 5: Supercharge with AI", `<p>IdeaM's AI features help you work smarter:</p>
<ul>
...
<p><strong>Need help?</strong> Click the <strong>?</strong> button for Help Chat — our AI assistant knows everything about IdeaM.</p>
