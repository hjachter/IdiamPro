...
This guide cannot be deleted, but you can copy it to create your own customized version.`, []);
  ...
  createNode(nodes, mediaId, rootId, "Importing Media", "Add photos, videos, PDFs, and other files to your content using 'Import File' in the Insert menu (+ icon) or by dragging files directly into the content pane. Images and videos are embedded inline; PDFs, audio, and other files are inserted as download links. Media is saved with your outline.", []);
