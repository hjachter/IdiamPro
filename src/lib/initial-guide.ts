...
This guide cannot be deleted, but you can copy it to create your own customized version.`, []);
  ...
  createNode(nodes, plansId, rootId, "Plans & Tiers", "IdiamPro has three plans: **Free**, **Pro**, and **Power**.\n\n**Important:** Plan limits only apply once accounts and billing are switched on. In this build there is no sign-in or checkout yet, so everything is unlocked for everyone exactly as it always has been — nothing below is enforced today.\n\n**What each plan includes (once active):**\n\n**Free**\n• Unlimited outlines, editing, and every item type\n• Local AI (Ollama) — unlimited, always\n• Bring your own AI key — unlimited, always\n• 10 cloud outline generations per month\n• 25 cloud content expansions per month\n\n**Pro ($12/mo)**\n• 100 cloud outline generations per month\n• Unlimited cloud content expansions\n• Cloud AI access plus premium AI features (subtree summaries, teach mode, consistency checks)\n• Premium website-export templates\n\n**Power ($28/mo)**\n• Unlimited cloud AI generations\n• Premium export and Universal Output formats\n• Podcast generation\n• Multi-LLM and priority processing\n\n**About the monthly limits:**\nThe outline-generation and content-expansion counts reset at the start of each calendar month. **Local Ollama AI and your own API key never count against these limits — they stay unlimited on every plan.** Only hosted cloud AI is metered.\n\n**If you hit a limit:**\nYou'll see a friendly upgrade prompt explaining what's reached (for example, \"You've used all 10 of your Free outline generations this month — resets on June 1\") with the plan benefits and an Upgrade button. Nothing fails silently and nothing is hard-blocked — and again, none of this happens unless accounts and billing are enabled.");
