...
This guide cannot be deleted, but you can copy it to create your own customized version.`, []);
  ...
  createNode(nodes, importExportId, manageId, "Import/Export", "IdiamPro supports importing and exporting outlines in many formats, making it easy to share your work and bring in content from other applications.\n\n**Export:** From the dropdown menu > 'Export Current Outline', or right-click any node > 'Export Subtree...' to export just that branch.\n\n**Import:** From the dropdown menu > 'Import Outline'. Drag and drop files or browse to select.", []);
