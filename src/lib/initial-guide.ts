...
This guide cannot be deleted, but you can copy it to create your own customized version.`, []);
  ...
  createNode(nodes, manageId, rootId, "Managing Outlines", "IdiamPro supports multiple outlines, each stored separately. The sidebar (open it with the panel-toggle button at the top-left of the toolbar) is the home for switching, creating, renaming, and deleting outlines. The toolbar shows the current outline's name as a read-only title, plus a small wrench icon for admin actions (Import, Export, Backup/Restore, Refresh User Guide). The guide outline is special — it's restored automatically and cannot be deleted or renamed.", []);
  ...
  createNode(nodes, importExportId, manageId, "Import/Export", "IdiamPro supports importing and exporting outlines in many formats, making it easy to share your work and bring in content from other applications.\n\n**Export:** Click the wrench icon in the toolbar (admin menu) > 'Export Current Outline', or right-click any node > 'Export Subtree...' to export just that branch. The toolbar's upload-arrow (Share) button also exports the selected subtree.\n\n**Import:** Click the wrench icon in the toolbar (admin menu) > 'Import Outline'. Drag and drop files or browse to select.\n\n**Backup & Restore:** The same admin menu has 'Backup All Outlines' (save everything to disk) and 'Restore All Outlines' (pull any outlines from the storage folder back into the sidebar).", []);
  ...
  // AI Menu
  createNode(nodes, aiMenuId, aiId, "AI Menu & Settings", "Access all AI features from a single menu:\n\n1. Click the sparkles icon in the toolbar\n2. The AI menu shows:\n   - Generate Subtree from Topic — creates an AI-generated subtree under the selected node\n   - Research & Import — import and synthesize content from external sources\n   - Knowledge Chat — search your outlines with natural language\n\nYour current plan (Free or Premium) is shown in the menu header.");
