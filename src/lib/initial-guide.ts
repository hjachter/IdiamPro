...
This guide cannot be deleted, but you can copy it to create your own customized version.`, []);
  ...
  createNode(nodes, mediaId, rootId, "Importing Media", "Add photos, videos, PDFs, and other files to your content using the Import File button (paperclip icon) in the toolbar, or by dragging files directly into the content pane. The file type is auto-detected: images and videos are embedded inline, while PDFs, audio, and other files are inserted as download links. Media is saved with your outline.", []);
