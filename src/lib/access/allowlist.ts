 ...
 *
 * IdeaM is in invite-only beta. Only emails Howard has explicitly
 ...
 * This matches the rest of IdeaM's env-gated layers (Sentry, Clerk,
 ...
 * here: IdeaM is in friend-and-family beta, the cost of confirming
...
export const GATE_MESSAGE =
  "IdeaM is in invite-only beta right now. Your email isn't on the invite list yet — drop us a note at support@2ndbrainware.com and we'll get you in.";
