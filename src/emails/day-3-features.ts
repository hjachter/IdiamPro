...
<p style="margin:0 0 16px;">One of the most useful things IdeaM can do is take an outline you wrote weeks ago and bring it up to date against the live web. We call it <strong>Refresh from Web</strong>.</p>
<p style="margin:0 0 16px;">Right-click any item and choose <em>Refresh from Web</em>. Every change is shown side-by-side so you can accept or reject each one &mdash; nothing is overwritten without your say-so. Nodes you've edited by hand are auto-skipped so your writing stays put.</p>
...
One of the most useful things IdeaM can do is take an outline you wrote weeks ago and bring it up to date against the live web. We call it Refresh from Web.

Right-click any item and choose Refresh from Web. Every change is shown side-by-side so you can accept or reject each one — nothing is overwritten without your say-so. Nodes you've edited by hand are auto-skipped so your writing stays put.
