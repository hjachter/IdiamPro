 ...
 *
 * Brand color: IdeaM's primary is iOS blue (#007AFF) — see globals.css.
...
/**
 * Wrap body content in the standard IdeaM email shell.
 */
...
<div style="max-width:560px;margin:0 auto;padding:32px 16px;">
  <div style="text-align:center;padding-bottom:24px;">
    <div style="font-size:22px;font-weight:700;letter-spacing:-0.01em;color:${BRAND_PRIMARY};">IdeaM</div>
  </div>
  ...
  <div style="text-align:center;padding-top:24px;font-size:12px;line-height:1.6;color:${TEXT_MUTED};">
    <div>IdeaM &mdash; the premier idea developer.</div>
    <div style="padding-top:8px;">
      You're getting this because you signed up for IdeaM.
...
---
IdeaM — the premier idea developer.
