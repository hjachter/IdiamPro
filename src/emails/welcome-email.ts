...
export interface WelcomeEmailProps {
  ...
  /** Optional CTA URL — defaults to the IDMPro app home. */
  appUrl?: string;
...
export function renderWelcomeEmail(props: WelcomeEmailProps): RenderedEmail {
  ...
  const bodyHtml = `
<h1 style="margin:0 0 16px;font-size:24px;line-height:1.3;font-weight:700;">Welcome to IDMPro</h1>
<p style="margin:0 0 16px;">${escapeHtml(hello)} &mdash; thanks for joining. IDMPro turns scattered notes, videos, PDFs, and half-formed ideas into structured outlines you can actually use.</p>
...
`;
  ...
  const bodyText = `${hello} — thanks for joining IDMPro.

IDMPro turns scattered notes, videos, PDFs, and half-formed ideas into structured outlines you can actually use.
