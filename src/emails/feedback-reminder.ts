...
<p style="margin:0 0 16px;">Howard here. It's been about two weeks since you got into the IdeaM beta — long enough to form an opinion. Mind sharing five minutes of feedback?</p>
...
<p style="margin:0 0 16px;color:#374151;">If you're up for a public quote on the IdeaM website, there's a section on the form for that — and a Founding User badge inside the app if you record a quick video.</p>
...
<p style="margin:0;color:#6B7280;font-size:14px;">Founder, IdeaM</p>`;

  const bodyText = `${hi},

Howard here. It's been about two weeks since you got into the IdeaM beta — long enough to form an opinion. Mind sharing five minutes of feedback?
...
If you're up for a public quote on the IdeaM website, there's a section on the form for that — and a Founding User badge inside the app if you record a quick video.
