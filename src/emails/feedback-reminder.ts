...
<p style="margin:0 0 16px;">Howard here. It's been about two weeks since you got into the IdiamPro beta — long enough to form an opinion. Mind sharing five minutes of feedback?</p>
...
<p style="margin:0 0 16px;color:#374151;">If you're up for a public quote on the IdiamPro website, there's a section on the form for that — and a Founding User badge inside the app if you record a quick video.</p>
...
Howard here. It's been about two weeks since you got into the IdiamPro beta — long enough to form an opinion. Mind sharing five minutes of feedback?
...
If you're up for a public quote on the IdiamPro website, there's a section on the form for that — and a Founding User badge inside the app if you record a quick video.
